<template>
  <div id="apply">
    ...
    <el-dialog title="经销信息" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="公司名" :label-width="formLabelWidth">
          <el-input v-model="form.name" auto-complete="off" placeholder="经销商"></el-input>
        </el-form-item>
        <el-form-item label="公司地址" :label-width="formLabelWidth">
          <el-input v-model="form.region" placeholder="公司地址"></el-input>
        </el-form-item>
        <el-form-item label="经销日期" :label-width="formLabelWidth">
          <el-date-picker
            v-model="form.date"
            type="date"
            :style="{'width':'100%'}"
