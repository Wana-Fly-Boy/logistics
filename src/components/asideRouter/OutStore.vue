<template>
  <div id="apply">
    ...
    <el-dialog title="出库信息" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="出库记录人" :label-width="formLabelWidth">
          <el-input v-model="form.name" auto-complete="off" placeholder="姓名"></el-input>
        </el-form-item>
        <el-form-item label="出库地址" :label-width="formLabelWidth">
          <el-input v-model="form.region" placeholder="出库地址"></el-input>
        </el-form-item>
...
const list = store.fetch('outStore');
export default {
    data() {
      return {
        list:list,
