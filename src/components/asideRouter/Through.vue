<template>
  <div id="apply">
    ...
    <el-dialog title="直达信息" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="交通方式" :label-width="formLabelWidth">
          <el-input v-model="form.name" auto-complete="off" placeholder="交通方式"></el-input>
        </el-form-item>
        <el-form-item label="目的地" :label-width="formLabelWidth">
          <el-input v-model="form.region" placeholder="目的地"></el-input>
        </el-form-item>
        <el-form-item label="直达日期" :label-width="formLabelWidth">
          <el-date-picker
            v-model="form.date"
            type="date"
            :style="{'width':'100%'}"
...
const list = store.fetch('through');
export default {
    data() {
      return {
        list:list,
