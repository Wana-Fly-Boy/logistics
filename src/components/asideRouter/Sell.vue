<template>
  <div id="apply">
    ...
    <el-dialog title="出售信息" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="公司名" :label-width="formLabelWidth">
          <el-input v-model="form.name" auto-complete="off" placeholder="购入者"></el-input>
        </el-form-item>
